/****************************************************************************
 *            defaultterrainmanager.cpp
 *
 * Author: 2010-2012  Daniel Jungmann <el.3d.source@googlemail.com>
 * Copyright: See COPYING file that comes with this distribution
 ****************************************************************************/

#include "defaultterrainmanager.hpp"
...
namespace eternal_lands
{
	...
	DefaultTerrainManager::DefaultTerrainManager(
	...
	void DefaultTerrainManager::add_terrain_pages(const String &effect,
