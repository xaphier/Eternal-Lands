...
namespace eternal_lands
{
	...
	namespace
	{
		...
		const EffectNodePortTypeData effect_node_port_datas[] =
		{
			...
			EffectNodePortTypeData(String(UTF8("x")), 1, true),
			EffectNodePortTypeData(String(UTF8("y")), 1, true),
			EffectNodePortTypeData(String(UTF8("z")), 1, true),
			EffectNodePortTypeData(String(UTF8("w")), 1, true),
			EffectNodePortTypeData(String(UTF8("rg")), 2, false),
			EffectNodePortTypeData(String(UTF8("xy")), 2, false),
			...
			EffectNodePortTypeData(String(UTF8("xyzw")), 4, false),
