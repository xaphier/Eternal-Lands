...
BOOST_AUTO_TEST_CASE(default_creation)
{
	...
	BOOST_CHECK_EQUAL(material_effect_description.get_texture(
		el::stt_dudv), "");
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(0
		)[0][0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(0
		)[0][1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(0
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(1
		)[0][0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(1
		)[0][1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(1
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(2
		)[0][0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(2
		)[0][1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(2
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(3
		)[0][0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(3
		)[0][1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_albedo_scale_offset(3
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(0
		)[0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(0
		)[1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(0
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(1
		)[0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(1
		)[1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(1
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(2
		)[0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(2
		)[1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(2
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(3
		)[0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(3
		)[1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_texture_scale_offset(3
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_emission_scale_offset(
		)[0][0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_emission_scale_offset(
		)[0][1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_emission_scale_offset(
	...
	BOOST_CHECK_CLOSE(material_effect_description.get_specular_scale_offset(
		)[0], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_specular_scale_offset(
		)[1], 1.0f, 1.0);
	BOOST_CHECK_CLOSE(material_effect_description.get_specular_scale_offset(
...
BOOST_AUTO_TEST_CASE(all)
{
	...
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(0.6787f, 4.342f, 345.0f, 76.0f), 0));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(0.356f, 43.3f, 5.0f, 176.0f), 1));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(-1.677f, -0.342f, -577.0f, -878.0f), 2));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(-10.6787f, -444.3f, -5.0f, -1.0f), 3));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_specular_scale_offset(
...
BOOST_AUTO_TEST_CASE(xml)
{
	el::XmlBuffer buffer(UTF8("<?xml version=\"1.0\" encoding=\"utf8\"?>"
		...
		"<texture_scale_offset_0>0.6787 4.342 345.0 76.0</texture_scale_offset_0>"
		"<texture_scale_offset_1>0.356 43.3 5.0 176.0</texture_scale_offset_1>"
		"<texture_scale_offset_2>-1.677 -0.342 -577.0 -878.0</texture_scale_offset_2>"
		"<texture_scale_offset_3>-10.6787 -444.3 -5.0 -1.0</texture_scale_offset_3>"
...
BOOST_AUTO_TEST_CASE(set_material_descriptiont)
{
	...
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(534.0f, -4.342f, -344.0f, 176.0f), 0));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(30.356f, 1443.3f, 2145.0f, 12176.0f), 1));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(-241.677f, -140.342f, -2577.0f, -88.40f), 2));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_texture_scale_offset(
			glm::vec4(-1.67f, -444.3f, -512.0f, -1.023f), 3));
	BOOST_CHECK_NO_THROW(
		material_effect_description.set_specular_scale_offset(
			glm::vec4(-1.1f, -44.03f, -1.035f, -2.01f)));
	BOOST_CHECK_NO_THROW(material_effect_description.set_material_name(
...
BOOST_AUTO_TEST_CASE(asign)
{
	...
	BOOST_CHECK_NO_THROW(
		material_effect_description_0.set_texture_scale_offset(
			glm::vec4(-10.6787f, -444.3f, -5.0f, -1.0f), 3));
	BOOST_CHECK_NO_THROW(
		material_effect_description_0.set_specular_scale_offset(
			glm::vec4(-1.7f, -4.0f, -15.0f, -21.0f)));
	...
	BOOST_CHECK_EQUAL(material_effect_description_1.get_texture(
		el::stt_dudv), ".,welrf43");
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(0)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(1)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(2)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_albedo_scale_offset(3)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(0)[0],
		0.6787f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(0)[1],
		4.342f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(0)[2],
		345.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(0)[3],
		76.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(1)[0],
		0.356f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(1)[1],
		43.3f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(1)[2],
		5.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(1)[3],
		176.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(2)[0],
		-1.677f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(2)[1],
		-0.342f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(2)[2],
		-577.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(2)[3],
		-878.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(3)[0],
		-10.6787f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(3)[1],
		-444.3f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(3)[2],
		-5.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_texture_scale_offset(3)[3],
		-1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_emission_scale_offset()[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_specular_scale_offset()[0],
		-1.7f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_specular_scale_offset()[1],
		-4.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_specular_scale_offset()[2],
		-15.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_0.get_specular_scale_offset()[3],
		-21.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(0)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(1)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(2)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_albedo_scale_offset(3)[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(0)[0],
		0.6787f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(0)[1],
		4.342f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(0)[2],
		345.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(0)[3],
		76.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(1)[0],
		0.356f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(1)[1],
		43.3f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(1)[2],
		5.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(1)[3],
		176.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(2)[0],
		-1.677f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(2)[1],
		-0.342f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(2)[2],
		-577.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(2)[3],
		-878.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(3)[0],
		-10.6787f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(3)[1],
		-444.3f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(3)[2],
		-5.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_texture_scale_offset(3)[3],
		-1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[0][0],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[0][1],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[0][2],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[0][3],
		1.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[1][0],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[1][1],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[1][2],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_emission_scale_offset()[1][3],
		0.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_specular_scale_offset()[0],
		-1.7f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_specular_scale_offset()[1],
		-4.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_specular_scale_offset()[2],
		-15.0f, 1.0);
	BOOST_CHECK_CLOSE(
		material_effect_description_1.get_specular_scale_offset()[3],
		-21.0f, 1.0);
...
BOOST_AUTO_TEST_CASE(equal)
{
	...
	BOOST_CHECK_NO_THROW(
		material_effect_description_1.set_texture_scale_offset(
			glm::vec4(-10.6787f, -444.3f, -5.0f, -1.0f), 3));
	BOOST_CHECK_NO_THROW(
		material_effect_description_1.set_specular_scale_offset(
			glm::vec4(-1.7f, -4.0f, -15.0f, -21.0f)));
