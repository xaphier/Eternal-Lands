...
BOOST_AUTO_TEST_CASE(default_creation)
{
	...
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(0), "");
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(1), "");
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(2), "");
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(3), "");

	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[0], "");
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[1], "");
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[2], "");
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[3], "");
}

BOOST_AUTO_TEST_CASE(albedo_map)
{
	el::ClipmapData clipmap_data;
	el::StringArray16 albedo_maps;
...
BOOST_AUTO_TEST_CASE(normal_map)
{
	el::ClipmapData clipmap_data;
	el::StringArray16 normal_maps;
...
BOOST_AUTO_TEST_CASE(specular_map)
{
	el::ClipmapData clipmap_data;
	el::StringArray16 specular_maps;
...
BOOST_AUTO_TEST_CASE(blend_map)
{
	el::ClipmapData clipmap_data;
	el::StringArray4 blend_maps;

	BOOST_FOREACH(el::String &name, blend_maps)
	{
		name = get_random_name();
	}

	BOOST_CHECK_NO_THROW(clipmap_data.set_blend_maps(blend_maps));
	...
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(0), blend_maps[0]);
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(1), blend_maps[1]);
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(2), blend_maps[2]);
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_map(3), blend_maps[3]);

	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[0], blend_maps[0]);
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[1], blend_maps[1]);
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[2], blend_maps[2]);
	BOOST_CHECK_EQUAL(clipmap_data.get_blend_maps()[3], blend_maps[3]);
}
